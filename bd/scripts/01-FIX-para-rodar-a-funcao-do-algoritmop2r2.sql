...
ALTER TABLE public.areacontampassivoambiental ADD COLUMN the_geom geometry;
...
ALTER TABLE public.areacontampassivoambiental ADD COLUMN risco character varying(150); 

-- Adicionar coluna idpassivo na tabela meioimpactado
ALTER TABLE public.meioimpactado ADD COLUMN idpassivo integer;
...
ALTER TABLE public.produtoquimareacontaminada ADD COLUMN idpassivo integer;
...
ALTER TABLE public.residuoareacontampasamb ADD COLUMN idpassivo integer;
...
ALTER TABLE public.estrutcontinstrgestambareacontam ADD COLUMN idpassivo integer;
